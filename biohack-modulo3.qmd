...
-   Las diferencias con las clásicas tablas de datos son:
    ...
    -   Los `tibbles` son más sensibles a errores del programador. Esto es una ventaja al ofrecer un ambiente donde identificarlos es más fácil..
...
::: {.title data-id="title"}
[Ejercicios 3.1](https://mmorenozam.github.io/biohack_progR/ejercicios_m3.html#ejercicios-3.1){target="_blank"}
:::
...
::: {.title data-id="title"}
[Ejercicios 3.2](https://mmorenozam.github.io/biohack_progR/ejercicios_m3.html#ejercicios-3.2){target="_blank"}
:::
